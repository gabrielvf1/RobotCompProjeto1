...
media = []
centro = []
atraso = 0.7E9 # 1 segundo e meio. Em nanossegundos
...
def roda_todo_frame(imagem):
	...
	try:
		...
		#identifica_features.identifica_feat(cv_image)
		#media, centro, area =  cormodule.identifica_cor(cv_image)
		#media, centro, area =  1,1,10
		
		#cv2.imshow("Camera", cv_image)
		#identifica_features.identifica_feat(cv_image)

		media, centro, area =  identifica_features.identifica_feat(cv_image)
		#media, centro, area =  cormodule.identifica_cor(cv_image)
